...
<template>
  <nav class="top-bar">
    <section class="top-bar__left">
      <button class="top-bar__logo" aria-label="Go to principal page">
        <IconTwitchLogo />
      </button>
      <div class="top-bar__title">{{ texts.midutch }}</div>
      <button class="top-bar__more" aria-label="Show more options">
        <IconOptions />
      </button>
    </section>
